...
function displayDataForName(data) {
  ...
  var seasonArray = [];
  $('.results').html('<h4 class="nameHeader">Name</h4>' + '<h4 class="titlesHeader">Titles</h4>' + '<h4 class="aliasesHeader">Aliases</h4>' + '<h4 class="bornHeader">Born</h4>' + '<h4 class="diedHeader">Died</h4>' + '<h4 class="cultureHeader">Culture</h4>' + '<h4 class="fatherHeader">Father</h4>' + '<h4 class="motherHeader">Mother</h4>' + '<h4 class="spouseHeader">Spouse</h4>' + '<h4 class="tvParent">Seasons</h4>' + '<h4 class="tvSeriesHeader"></h4>' + '<h4 class="playedByHeader">Actors</h4>');
